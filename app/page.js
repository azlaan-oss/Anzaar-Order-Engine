    ...
    <div className="max-w-[1600px] mx-auto space-y-4 pb-20 px-4 md:px-10">
      ...
      <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 pt-0">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-end gap-3 w-full md:w-auto">
          <div className="flex items-center bg-white p-1.5 rounded-full border border-black/5 shadow-xl w-full md:w-auto overflow-x-auto no-scrollbar justify-center md:justify-start">
            {['today', 'yesterday', '7days', 'month'].map((f) => (
              <button 
                ...
                className={`px-3 md:px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${
            ...
            <button 
              ...
              className={`px-4 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center shrink-0 ${

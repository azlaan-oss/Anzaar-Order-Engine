  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <p style={{ fontSize: '11px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#52525b', margin: 0, fontWeight: 700 }}>
          Official Invoice
        </p>
      </div>
      ...
      {/* ── CREATIVE & ENGAGING IMPORTANT NOTES ── */}
      <div style={{ marginTop: '40px' }}>
        <div style={{
          background: '#09090b', borderRadius: '16px', padding: '24px 32px', color: '#ffffff',
          boxShadow: '0 10px 25px rgba(0,0,0,0.1)'
        }}>
          <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span style={{ fontSize: '32px' }}>👀</span>
            <div>
              <h2 style={{ fontSize: '20px', fontWeight: 900, margin: '0 0 4px', color: '#ffffff' }}>একটু সময় দিন!</h2>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontSize: '13.5px', color: '#ecfdf5', margin: 0, fontWeight: 500, lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={{ background: '#18181b', borderRadius: '12px', padding: '16px', border: '1px solid #27272a' }}>
                ...
                <h3 style={{ fontSize: '14px', fontWeight: 800, margin: '0 0 6px', color: '#ffffff' }}>রঙের তারতম্য</h3>
                <p style={{ fontSize: '12.5px', color: '#a1a1aa', margin: 0, lineHeight: 1.5, fontWeight: 500 }}>
                  ক্যামেরা ও লাইটিং এর কারণে বাস্তবের পণ্যের কালার একটু ভিন্ন হতে পারে, যা সম্পূর্ণ স্বাভাবিক।
                </p>
              </div>

              <div style={{ background: '#18181b', borderRadius: '12px', padding: '16px', border: '1px solid #27272a' }}>
                <span style={{ fontSize: '24px', display: 'block', marginBottom: '8px' }}>🔁</span>
                <h3 style={{ fontSize: '14px', fontWeight: 800, margin: '0 0 6px', color: '#ffffff' }}>এক্সচেঞ্জ সুবিধা</h3>
                <p style={{ fontSize: '12.5px', color: '#a1a1aa', margin: 0, lineHeight: 1.5, fontWeight: 500 }}>
            ...
            {/* 3. Negative Case Warning */}
            <div style={{
              background: '#3f1118', borderRadius: '12px', padding: '16px 20px', display: 'flex', gap: '16px', alignItems: 'center',
              ...
              <div>
                ...
                <p style={{ fontSize: '12.5px', color: '#fecaca', margin: 0, fontWeight: 500, lineHeight: 1.5 }}>
                  কাস্টমাইজড সাইজ, ডিসকাউন্ট পণ্য বা ব্যবহার করা পণ্যের ক্ষেত্রে কোনো প্রকার রিটার্ন বা এক্সচেঞ্জ প্রযোজ্য হবে না।
                </p>
              </div>
            </div>
